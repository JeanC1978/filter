...
export default function MultipleSelectPlaceholder() {
  ...
  return (
    <div>
      ...
      <FormControl > 
      <h5>1. La vivienda del postulante es propia:</h5>
        ...
        <Grid alignItems="center">
          ...
          <FormControlLabel item xs={2} value="c" control={<Radio />} label="Alquiler" />
        </Grid>
        </RadioGroup> 
      </FormControl>
      </Grid>
      ...
      <Grid container marginTop={2} >
      <FormControl > 
      <h5>2. Percibió bonificación extra.</h5>
        <RadioGroup aria-label="option" name="option"  >
        <Grid alignItems="center">
          <FormControlLabel item xs="auto" value="a" control={<Radio />} label="Si" />
          <FormControlLabel item xs="auto" value="b" control={<Radio />} label="No" />
      ...
      <Grid container marginTop={2} >
      <FormControl > 
      <h5>3. Ayuda económicamente en su hogar.</h5>
        <RadioGroup aria-label="option" name="option"  >
        <Grid alignItems="center">
          <FormControlLabel item xs="auto" value="a" control={<Radio />} label="Si" />
          <FormControlLabel item xs="auto" value="b" control={<Radio />} label="No" />
